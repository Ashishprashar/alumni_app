          ...
          return Scaffold(
            body: onboardingProvider.isLoading
                ...
                : getAppropriateWidget(
                    context, onboardingProvider.applicationStatus),
          );
        },
      ),
    );
...
// get back to this after  you have changed the application reposnse model

Widget getAppropriateWidget(
    BuildContext context, ApplicationStatus _applicationStatus) {
  // query firebase applicationREspose collection
  // if no response. show pending widget
  // if reponse - check accepted/rejected and show their screens.
