                              ...
                              children: [
                                    ...
                                    await showDialog(
                                        ...
                                        builder: (ctx) {
                                          return ImagePickerWidget(
                                            ...
                                            setState(() {
                                              editProvider.profileImage = image;
                                            });
                                          });
                                        });
                                  },
                                ...
                                Row(
                                  ...
                                  children: [
                                    EditableSocialIcons(
                                      controllerText:
                                          editProvider.twitterController.text,
                                      socialName: 'twitter',
                                      onControllerChanged:
                                    ...
                                    EditableSocialIcons(
                                      controllerText:
                                          editProvider.linkedinController.text,
                                      socialName: 'linkedin',
                                      onControllerChanged:
                                          (TextEditingController
                                              temporaryController) {
                                    ...
                                    EditableSocialIcons(
                                      controllerText:
                                          editProvider.facebookController.text,
                                      socialName: 'facebook',
                                      onControllerChanged:
                                          (TextEditingController
                                              temporaryController) {
                                    ...
                                    EditableSocialIcons(
                                      controllerText:
                                          editProvider.instagramController.text,
                                    ...
                                    EditableSocialIcons(
                                      controllerText:
                                          editProvider.githubController.text,
                                      socialName: 'github',
                                      onControllerChanged:
                                          (TextEditingController
                                              temporaryController) {
